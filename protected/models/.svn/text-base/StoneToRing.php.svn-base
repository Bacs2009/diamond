<?php
class StoneToRing extends CActiveRecord
{
  ...
  {
    return array('rings' => array(self::BELONGS_TO, 'Rings', 'ring_id'),'stones' => array(self::BELONGS_TO, 'Stones', 'stone_id'));
  }
