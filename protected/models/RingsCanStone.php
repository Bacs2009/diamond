<?php
class RingsCanStone extends CActiveRecord
{
  ...
  {
    return array('rings' => array(self::BELONGS_TO, 'Rings', 'ring_id'),
     'stones_types' => array(self::BELONGS_TO, 'StonesTypes', 'stone_id'));
  }
