<?php
class RingsCanMetal extends CActiveRecord
{
  ...
  {
    return array('rings' => array(self::BELONGS_TO, 'Rings', 'ring_id'),'metalls' => array(self::BELONGS_TO, 'JewelleryMetals', 'metal_id'));
  }
