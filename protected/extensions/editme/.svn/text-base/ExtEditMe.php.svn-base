...
class ExtEditMe extends CInputWidget {
	 ...
	 */
	public $filebrowserBrowseUrl = 'http://rings_dev.rein.dev.studio7.com.ua//filemanager/browser/default/browser.html?Connector=../../connectors/php/connector.php';
//	echo $filebrowserBrowseUrl; die;

	/**
	 * @var string URL to the filebrowser (flash dialog).
	 */
	public $filebrowserFlashBrowseUrl = 'http://rings_dev.rein.dev.studio7.com.ua/filemanager/browser/default/browser.html?Connector=../../connectors/php/connector.php&default_path=';

	/**
	 * @var string URL to the filebrowser (image dialog).
	 */
	public $filebrowserImageBrowseUrl = 'http://rings_dev.rein.dev.studio7.com.ua/filemanager/browser/default/browser.html?Connector=../../connectors/php/connector.php&default_path=';

	/**
	 * @var string URL to the filebrowser (link tab in image dialog).
	 */
	public $filebrowserImageBrowseLinkUrl = 'http://rings_dev.rein.dev.studio7.com.ua/filemanager/browser/default/browser.html?Connector=../../connectors/php/connector.php';
	...
	private function _publish() {
		if(empty(self::$_CKEditorURL)) {
			...
			self::$_CKEditorURL = Yii::app() -> assetManager -> publish($CKEditorExtPath, false, -1, YII_DEBUG);
