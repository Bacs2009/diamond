...
( function() {
    CKEDITOR.plugins.add( 'MediaEmbed',
    {
        ...
        init: function( editor )
        {
		  ...
		  final_html = 'MediaEmbedInsertData|---' + escape('<div class="media_embed" style="width:100%; height: 70px; background: url(\'../images/multimedia.png\')">'+content+'</div>') + '---|MediaEmbedInsertData';
                    editor.insertHtml(final_html);
                    updated_editor_data = editor.getData();
                    clean_editor_data = updated_editor_data.replace(final_html,'<div class="media_embed" style="width:100%; height: 70px; background: url(\'../images/multimedia.png)\'">'+content+'</div>');
