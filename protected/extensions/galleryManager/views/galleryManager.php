...
<div class="GalleryEditor<?php echo $cls?>" id="<?php echo $this->id?>">
    <div class="gform">
        <span class="btn btn-success fileinput-button">
            ...
            <?php echo Yii::t('galleryManager.main', 'Добавить изображения…');?>
...
<!--        <span class="btn disabled edit_selected"><?php echo Yii::t('galleryManager.main', 'Edit selected');?></span> -->
        <span class="btn disabled remove_selected"><?php echo Yii::t('galleryManager.main', 'Удалить выделенные');?></span>

        <label for="select_all_<?php echo $this->id?>" class="btn" style="font-size: 1em;">
            <input type="checkbox" style="margin: 0;" id="select_all_<?php echo $this->id?>" class="select_all"/>
            <?php echo Yii::t('galleryManager.main', 'Выделить все');?>
        </label>
        ...
        <div class="images">
            ...
            <div id="<?php echo $this->id . '-' . $photo->id ?>" class="photo">
                ...
                <div class="actions">
                    ...
                    echo ' <span data-photo-id="' . $photo->id . '" class="btn btn-danger deletePhoto"><i class="icon-remove icon-white"></i></span>';
                    ?>
                </div>
