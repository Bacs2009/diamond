...
class ETwigViewRenderer extends CApplicationComponent implements IViewRenderer {
    ...
    function init() {
        ...
        // beginWidget
        //$this->_twig->addFunction('beginWidget', new Twig_Function_Function('$context["this"]->beginWidget'));

        // endWidget
        //$this->_twig->addFunction('endWidget', new Twig_Function_Function('$this->endWidget'));
...
function ETwigViewRendererbeginWidgetFunction($class, $data) {
    return "this.widget('zii.widgets.CBreadcrumbs',{'links':['a','b']}, true)";
}